...
from dataset.load_dataset import read_freesolv_assay
...
# def write_split(ligand_sets, out_dir, dataset_name="freesolv", ratios=(0.8,0.1,0.1), seed=42):
...
def main():
    args = Args()
    data = read_freesolv_assay(csv_path=None, min_group_size=10, fallback_chunk=20, max_task_size=30)
    ligand_sets = data["ligand_sets"]
    out_dir = "./freesolv_processed"
    ...
    write_split(ligand_sets, out_dir, dataset_name="freesolv", seed=args.seed)
    write_metadata_from_ligand_sets(ligand_sets, out_dir, dataset_name="freesolv")
